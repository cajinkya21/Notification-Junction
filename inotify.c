			...
			if (event->len) {
			  		...
			  		if (event->mask & IN_CREATE) {
						if (event->mask & IN_ISDIR) {
							printf("NOTIFICATION : NEW DIRECTORY %s CREATED.\n", event->name);
							strcpy(retStr, "NOTIFICATION : NEW DIRECTORY ");
							strcat(retStr, event->name);
							strcat(retStr, " CREATED.");
						}
						else {
							printf("New file %s created.\n", event->name);
							strcpy(retStr, "NOTIFICATION : NEW FILE ");
							strcat(retStr, event->name);
							strcat(retStr, " CREATED.");
						}
					}
						...
						if (event->mask & IN_ISDIR) {
							...
							strcpy(retStr, "NOTIFICATION : DIRECTORY ");
							strcat(retStr, event->name);
